...
ent-ShippingContainerNanotrasen = грузовой контейнер Voidkol
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображён логотип компании Voidkol, и поэтому внутри может быть что угодно.
