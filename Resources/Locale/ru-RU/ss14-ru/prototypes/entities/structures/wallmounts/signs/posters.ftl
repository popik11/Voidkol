...
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как Voidkol сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов Voidkol. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном Voidkol на космической станции, полной барсуков.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами Voidkol.
...
ent-PosterContrabandRebelsUnite = Бунтари вместе
    .desc = Плакат, призывающий читателя восстать против Voidkol.
...
ent-PosterLegitNanotrasenLogo = Логотип 

    .desc = Плакат с изображением логотипа Voidkol.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвящённого 50-летию компании Nanoposters Manufacturing, дочерней компании Voidkol.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков Voidkol.
ent-PosterLegitEnlist = Вступай!
    .desc = Запишитесь в резерв эскадрона смерти Voidkol сегодня!
...
ent-PosterLegitNoERP = Скажи "НЕТ" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография запрещены на станциях "Voidkol".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = Voidkol распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
...
ent-PosterLegitVacation = Корпоративные привилегии Voidkol: Отпуск
...
ent-PosterLegitRenault = Постер с Алисой
    .desc = Йап.
ent-PosterLegitNTTGC = Тактическая карточная игра Voidkol
    .desc = Реклама новой ТКИ от Voidkol: ПОКУПАЙТЕ БОЛЬШЕ КАРТОЧЕК.
