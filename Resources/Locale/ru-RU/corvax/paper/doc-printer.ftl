doc-text-printer-report-station =
   ...
   ⠀[color=#1b487e]░░█░██░██░░██░█░░[/color]               [head=3]Voidkol[/head]
...
doc-text-printer-shuttle-registration-request =
    ...
    Я, (ФИО), в должности (полное наименование должности), прошу провести регистрацию шаттла в системе Voidkol для идентификации.
    Размеры шаттла:
...
doc-text-printer-note-beginning-military-actions =
    ...
    Неуважаемые корпоративные крысы Voidkol! Синдикат официально объявляет о начале военных действий с вами, а также о начале операции по вашему истреблению.
